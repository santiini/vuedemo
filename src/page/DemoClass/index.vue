<template>
  <div class="home">
    <group>
      <x-button @click.native="printProps">实例属性 和 静态属性</x-button>
      <x-button @click.native="executeMethods">执行实例方法和静态方法</x-button>
      <x-button @click.native="changeProps">改变实例属性 : OK</x-button>
      <x-button @click.native="changeStaticProps">改变class 的静态属性 : OK</x-button>
      <x-button @click.native="printConstProps">不可变更属性 -- 实例属性</x-button>
      <x-button @click.native="printStaticConst">不可变更属性 -- 静态属性</x-button>
      <x-button @click.native="testProps">静态属性和实例属性的关联</x-button>
      <x-button @click.native="testChangeProps">改变实例属性 --setter和 getter</x-button>
    </group>
  </div>
</template>
